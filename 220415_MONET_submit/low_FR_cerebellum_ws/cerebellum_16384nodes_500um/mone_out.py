...
def write_job_script_fugaku(sd, rd_array):
    ...
    large_upper_limit = 10000
    huge_upper_limit = 152064
...
def write_job_script_fugaku_detail_profile(sd, rd_array):
    ...
    # simple profile 
    #n_sample_detail_profile = 5
    # standard profile 
    #n_sample_detail_profile = 12
    # detail profile 
    n_sample_detail_profile = 17
    ...
    for i in range(1, n_sample_detail_profile+1):
...
def make_switch_strings(sd):
    ...
    L_temp.append(str(sd["record_settings"]["switch"]))
    if sd["record_settings"]["switch"] == True:
        # master_zero, all, one_per_region, process_ID 
        L_temp.append(", process_rank, ")
        L_temp.append(str(sd["record_settings"]["process_rank"]))
    L_temp.append("\n")
